...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("BodyApplyImageTextAsciifyPost".equalsIgnoreCase(className)) {
      return new TypeToken<List<BodyApplyImageTextAsciifyPost>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("BodyApplyImageTextAsciifyPost".equalsIgnoreCase(className)) {
      return new TypeToken<BodyApplyImageTextAsciifyPost>(){}.getType();
    }
