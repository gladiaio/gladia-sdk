...
*OASImageTextAsciifyApi* | [**applyImageTextAsciifyPost**](OASImageTextAsciifyApi.md#applyImageTextAsciifyPost) | **POST** /image/text/asciify/ | Apply model for the asciify task for a given models
*OASImageTextAsciifyApi* | [**getVersionsImageTextAsciifyGet**](OASImageTextAsciifyApi.md#getVersionsImageTextAsciifyGet) | **GET** /image/text/asciify/ | Get list of models available for asciify
*OASImageTextOcrApi* | [**applyImageTextOcrPost**](OASImageTextOcrApi.md#applyImageTextOcrPost) | **POST** /image/text/ocr/ | Apply model for the ocr task for a given models
