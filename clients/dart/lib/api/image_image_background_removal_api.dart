...
class ImageImageBackgroundRemovalApi {
  ...
  ImageImageBackgroundRemovalApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the background-removal task for a given models
  ///
  /// 
  Future<Object> applyImageImageBackgroundRemovalPost(MultipartFile image, { String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsImageImageBackgroundRemovalGet() async {
    Object postBody;
