...
class ImageImageColorizationApi {
  ...
  ImageImageColorizationApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the colorization task for a given models
  ///
  /// 
  Future<Object> applyImageImageColorizationPost(MultipartFile image, { String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsImageImageColorizationGet() async {
    Object postBody;
