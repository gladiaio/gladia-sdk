...
class ImageImageRestorationApi {
  ...
  ImageImageRestorationApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the restoration task for a given models
  ///
  /// 
  Future<Object> applyImageImageRestorationPost(MultipartFile image, { String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsImageImageRestorationGet() async {
    Object postBody;
