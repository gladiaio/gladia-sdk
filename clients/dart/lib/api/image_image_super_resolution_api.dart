...
class ImageImageSuperResolutionApi {
  ...
  ImageImageSuperResolutionApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the super-resolution task for a given models
  ///
  /// 
  Future<Object> applyImageImageSuperResolutionPost(MultipartFile image, { String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsImageImageSuperResolutionGet() async {
    Object postBody;
