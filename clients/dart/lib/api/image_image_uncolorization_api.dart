...
class ImageImageUncolorizationApi {
  ...
  ImageImageUncolorizationApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the uncolorization task for a given models
  ///
  /// 
  Future<Object> applyImageImageUncolorizationPost(MultipartFile image, { String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsImageImageUncolorizationGet() async {
    Object postBody;
