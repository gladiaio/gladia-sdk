...
class ImageTextAsciifyApi {
  ...
  ImageTextAsciifyApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the asciify task for a given models
  ///
  /// 
  Future<Object> applyImageTextAsciifyPost(MultipartFile image, { String model }) async {
    Object postBody;
    ...
    String path = "/image/text/asciify/".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future<Object> getVersionsImageTextAsciifyGet() async {
    Object postBody;
