...
class ImageTextOcrApi {
  ...
  ImageTextOcrApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the ocr task for a given models
  ///
  /// 
  Future<Object> applyImageTextOcrPost(MultipartFile image, { String sourceLanguage, String model }) async {
    Object postBody;
    ...
    String path = "/image/text/ocr/".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future<Object> getVersionsImageTextOcrGet() async {
    Object postBody;
