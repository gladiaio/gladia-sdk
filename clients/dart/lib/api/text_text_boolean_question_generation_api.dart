...
class TextTextBooleanQuestionGenerationApi {
  ...
  TextTextBooleanQuestionGenerationApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the boolean-question-generation task for a given models
  ///
  /// 
  Future<Object> applyTextTextBooleanQuestionGenerationPost({ String text, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextBooleanQuestionGenerationGet() async {
    Object postBody;
