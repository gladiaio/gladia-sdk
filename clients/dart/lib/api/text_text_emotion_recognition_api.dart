...
class TextTextEmotionRecognitionApi {
  ...
  TextTextEmotionRecognitionApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the emotion-recognition task for a given models
  ///
  /// 
  Future<Object> applyTextTextEmotionRecognitionPost({ String text, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextEmotionRecognitionGet() async {
    Object postBody;
