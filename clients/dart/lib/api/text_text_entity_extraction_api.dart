...
class TextTextEntityExtractionApi {
  ...
  TextTextEntityExtractionApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the entity-extraction task for a given models
  ///
  /// 
  Future<Object> applyTextTextEntityExtractionPost({ String inputString, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextEntityExtractionGet() async {
    Object postBody;
