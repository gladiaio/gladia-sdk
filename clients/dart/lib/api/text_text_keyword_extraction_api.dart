...
class TextTextKeywordExtractionApi {
  ...
  TextTextKeywordExtractionApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the keyword-extraction task for a given models
  ///
  /// 
  Future<Object> applyTextTextKeywordExtractionPost({ String text, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextKeywordExtractionGet() async {
    Object postBody;
