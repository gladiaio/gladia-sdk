...
class TextTextLanguageGenerationApi {
  ...
  TextTextLanguageGenerationApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the language-generation task for a given models
  ///
  /// 
  Future<Object> applyTextTextLanguageGenerationPost({ String text, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextLanguageGenerationGet() async {
    Object postBody;
