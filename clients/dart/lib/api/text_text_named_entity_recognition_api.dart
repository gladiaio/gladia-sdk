...
class TextTextNamedEntityRecognitionApi {
  ...
  TextTextNamedEntityRecognitionApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the named-entity-recognition task for a given models
  ///
  /// 
  Future<Object> applyTextTextNamedEntityRecognitionPost({ String text, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextNamedEntityRecognitionGet() async {
    Object postBody;
