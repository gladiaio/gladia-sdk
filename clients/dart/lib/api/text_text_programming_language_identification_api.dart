...
class TextTextProgrammingLanguageIdentificationApi {
  ...
  TextTextProgrammingLanguageIdentificationApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the programming-language-identification task for a given models
  ///
  /// 
  Future<Object> applyTextTextProgrammingLanguageIdentificationPost({ String text, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextProgrammingLanguageIdentificationGet() async {
    Object postBody;
