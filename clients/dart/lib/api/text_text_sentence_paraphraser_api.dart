...
class TextTextSentenceParaphraserApi {
  ...
  TextTextSentenceParaphraserApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the sentence-paraphraser task for a given models
  ///
  /// 
  Future<Object> applyTextTextSentenceParaphraserPost({ String context, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextSentenceParaphraserGet() async {
    Object postBody;
