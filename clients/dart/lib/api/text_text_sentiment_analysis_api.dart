...
class TextTextSentimentAnalysisApi {
  ...
  TextTextSentimentAnalysisApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the sentiment-analysis task for a given models
  ///
  /// 
  Future<Object> applyTextTextSentimentAnalysisPost({ String text, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextSentimentAnalysisGet() async {
    Object postBody;
