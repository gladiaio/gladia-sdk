...
class TextTextTranslationApi {
  ...
  TextTextTranslationApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the translation task for a given models
  ///
  /// 
  Future<Object> applyTextTextTranslationPost({ String inputString, String sourceLanguage, String targetLanguage, String model }) async {
    Object postBody;
    ...
    if(targetLanguage != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "target_language", targetLanguage));
    }
    if(model != null) {
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextTranslationGet() async {
    Object postBody;
