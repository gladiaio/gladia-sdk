...
class TextTextTransliterationApi {
  ...
  TextTextTransliterationApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// Apply model for the transliteration task for a given models
  ///
  /// 
  Future<Object> applyTextTextTransliterationPost({ String text, String language, String model }) async {
    Object postBody;
  ...
  ///
  /// 
  Future<Object> getVersionsTextTextTransliterationGet() async {
    Object postBody;
