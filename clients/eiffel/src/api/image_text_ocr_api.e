...
feature -- API Access
	...
	apply_image_text_ocr_post (image: FILE; source_language: STRING_32; model: STRING_32): detachable ANY
			...
			-- 
			-- argument: model  (optional, default to easy-ocr)
			-- 
			-- 
			-- Result ANY
		require
	...
	versions_image_text_ocr_get : detachable ANY
