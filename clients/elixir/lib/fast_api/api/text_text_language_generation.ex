...
defmodule FastAPI.Api.TextTextLanguageGeneration do
  ...
  """
  @spec apply_text_text_language_generation_post(Tesla.Env.client, keyword()) :: {:ok, Map.t} | {:error, Tesla.Env.t}
  def apply_text_text_language_generation_post(connection, opts \\ []) do
    optional_params = %{
      :"text" => :query,
      :"model" => :query
    }
  ...
  {:error, info} on failure
  """
  @spec get_versions_text_text_language_generation_get(Tesla.Env.client, keyword()) :: {:ok, Map.t} | {:error, Tesla.Env.t}
  def get_versions_text_text_language_generation_get(connection, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/text/text/language-generation/")
    |> Enum.into([])
