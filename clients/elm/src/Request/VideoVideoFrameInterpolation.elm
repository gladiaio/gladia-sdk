...
module Request.VideoVideoFrameInterpolation exposing (applyVideoVideoFrameInterpolationPost, getVersionsVideoVideoFrameInterpolationGet)
...
applyVideoVideoFrameInterpolationPost :
    ...
    -> Cmd msg
applyVideoVideoFrameInterpolationPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsVideoVideoFrameInterpolationGet :
    ...
    -> Cmd msg
getVersionsVideoVideoFrameInterpolationGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
