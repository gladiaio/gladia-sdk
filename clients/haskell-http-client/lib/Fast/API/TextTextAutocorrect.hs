...
module Fast.API.TextTextAutocorrect where
...
-- 
applyTextTextAutocorrectPost 
  :: FastRequest ApplyTextTextAutocorrectPost MimeNoContent A.Value MimeJSON
applyTextTextAutocorrectPost =
  _mkRequest "POST" ["/text/text/autocorrect/"]

data ApplyTextTextAutocorrectPost  
...
-- 
getVersionsTextTextAutocorrectGet 
  :: FastRequest GetVersionsTextTextAutocorrectGet MimeNoContent A.Value MimeJSON
getVersionsTextTextAutocorrectGet =
  _mkRequest "GET" ["/text/text/autocorrect/"]

data GetVersionsTextTextAutocorrectGet  
-- | @application/json@
instance Produces GetVersionsTextTextAutocorrectGet MimeJSON
