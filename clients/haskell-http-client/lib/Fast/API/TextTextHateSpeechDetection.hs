...
module Fast.API.TextTextHateSpeechDetection where
...
-- 
applyTextTextHateSpeechDetectionPost 
  :: FastRequest ApplyTextTextHateSpeechDetectionPost MimeNoContent A.Value MimeJSON
applyTextTextHateSpeechDetectionPost =
  _mkRequest "POST" ["/text/text/hate-speech-detection/"]

data ApplyTextTextHateSpeechDetectionPost  
...
-- 
getVersionsTextTextHateSpeechDetectionGet 
  :: FastRequest GetVersionsTextTextHateSpeechDetectionGet MimeNoContent A.Value MimeJSON
getVersionsTextTextHateSpeechDetectionGet =
  _mkRequest "GET" ["/text/text/hate-speech-detection/"]

data GetVersionsTextTextHateSpeechDetectionGet  
-- | @application/json@
instance Produces GetVersionsTextTextHateSpeechDetectionGet MimeJSON
