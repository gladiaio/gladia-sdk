...
module Fast.API.TextTextKeywordExtraction where
...
-- 
applyTextTextKeywordExtractionPost 
  :: FastRequest ApplyTextTextKeywordExtractionPost MimeNoContent A.Value MimeJSON
applyTextTextKeywordExtractionPost =
  _mkRequest "POST" ["/text/text/keyword-extraction/"]

data ApplyTextTextKeywordExtractionPost  
...
-- 
getVersionsTextTextKeywordExtractionGet 
  :: FastRequest GetVersionsTextTextKeywordExtractionGet MimeNoContent A.Value MimeJSON
getVersionsTextTextKeywordExtractionGet =
  _mkRequest "GET" ["/text/text/keyword-extraction/"]

data GetVersionsTextTextKeywordExtractionGet  
-- | @application/json@
instance Produces GetVersionsTextTextKeywordExtractionGet MimeJSON
