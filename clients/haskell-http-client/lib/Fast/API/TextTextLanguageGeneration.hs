...
module Fast.API.TextTextLanguageGeneration where
...
-- 
applyTextTextLanguageGenerationPost 
  :: FastRequest ApplyTextTextLanguageGenerationPost MimeNoContent A.Value MimeJSON
applyTextTextLanguageGenerationPost =
  _mkRequest "POST" ["/text/text/language-generation/"]

data ApplyTextTextLanguageGenerationPost  
...
-- 
getVersionsTextTextLanguageGenerationGet 
  :: FastRequest GetVersionsTextTextLanguageGenerationGet MimeNoContent A.Value MimeJSON
getVersionsTextTextLanguageGenerationGet =
  _mkRequest "GET" ["/text/text/language-generation/"]

data GetVersionsTextTextLanguageGenerationGet  
-- | @application/json@
instance Produces GetVersionsTextTextLanguageGenerationGet MimeJSON
