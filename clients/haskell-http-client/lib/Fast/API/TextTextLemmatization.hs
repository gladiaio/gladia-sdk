...
module Fast.API.TextTextLemmatization where
...
-- 
applyTextTextLemmatizationPost 
  :: FastRequest ApplyTextTextLemmatizationPost MimeNoContent A.Value MimeJSON
applyTextTextLemmatizationPost =
  _mkRequest "POST" ["/text/text/lemmatization/"]

data ApplyTextTextLemmatizationPost  
...
-- 
getVersionsTextTextLemmatizationGet 
  :: FastRequest GetVersionsTextTextLemmatizationGet MimeNoContent A.Value MimeJSON
getVersionsTextTextLemmatizationGet =
  _mkRequest "GET" ["/text/text/lemmatization/"]

data GetVersionsTextTextLemmatizationGet  
-- | @application/json@
instance Produces GetVersionsTextTextLemmatizationGet MimeJSON
