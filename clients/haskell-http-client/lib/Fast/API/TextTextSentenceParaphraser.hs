...
module Fast.API.TextTextSentenceParaphraser where
...
-- 
applyTextTextSentenceParaphraserPost 
  :: FastRequest ApplyTextTextSentenceParaphraserPost MimeNoContent A.Value MimeJSON
applyTextTextSentenceParaphraserPost =
  _mkRequest "POST" ["/text/text/sentence-paraphraser/"]

data ApplyTextTextSentenceParaphraserPost  
...
-- 
getVersionsTextTextSentenceParaphraserGet 
  :: FastRequest GetVersionsTextTextSentenceParaphraserGet MimeNoContent A.Value MimeJSON
getVersionsTextTextSentenceParaphraserGet =
  _mkRequest "GET" ["/text/text/sentence-paraphraser/"]

data GetVersionsTextTextSentenceParaphraserGet  
-- | @application/json@
instance Produces GetVersionsTextTextSentenceParaphraserGet MimeJSON
