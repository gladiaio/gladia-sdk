...
setHeader :: FastRequest req contentType res accept -> [NH.Header] -> FastRequest req contentType res accept
...
setQuery :: FastRequest req contentType res accept -> [NH.QueryItem] -> FastRequest req contentType res accept
setQuery req query = 
  req &
  L.over
