...
*FastApi.ImageTextAsciifyApi* | [**applyImageTextAsciifyPost**](docs/ImageTextAsciifyApi.md#applyImageTextAsciifyPost) | **POST** /image/text/asciify/ | Apply model for the asciify task for a given models
*FastApi.ImageTextAsciifyApi* | [**getVersionsImageTextAsciifyGet**](docs/ImageTextAsciifyApi.md#getVersionsImageTextAsciifyGet) | **GET** /image/text/asciify/ | Get list of models available for asciify
*FastApi.ImageTextOcrApi* | [**applyImageTextOcrPost**](docs/ImageTextOcrApi.md#applyImageTextOcrPost) | **POST** /image/text/ocr/ | Apply model for the ocr task for a given models
