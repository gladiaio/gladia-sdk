...
public interface ImageTextAsciifyApi  {
    ...
    @ApiOperation(value = "Apply model for the asciify task for a given models", tags={  })
    @ApiResponses(value = { 
    ...
    public Object applyImageTextAsciifyPost( @Multipart(value = "image" ) Attachment imageDetail, @QueryParam("model") @DefaultValue("ramesh-aditya")String model);
    ...
    @Path("/image/text/asciify/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get list of models available for asciify", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Response", response = Object.class) })
