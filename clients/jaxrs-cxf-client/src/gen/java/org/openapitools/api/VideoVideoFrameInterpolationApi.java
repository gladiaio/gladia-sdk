...
public interface VideoVideoFrameInterpolationApi  {
    ...
    @ApiOperation(value = "Apply model for the frame-interpolation task for a given models", tags={  })
    @ApiResponses(value = { 
    ...
    public Object applyVideoVideoFrameInterpolationPost( @Multipart(value = "video" ) Attachment videoDetail, @QueryParam("model") @DefaultValue("deep-animation-video-interpolation-in-the-wild")String model);
    ...
    @Path("/video/video/frame-interpolation/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get list of models available for frame-interpolation", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Response", response = Object.class) })
