...
#
package WWW::OpenAPIClient::TextTextKeywordExtractionApi;
...
#
# apply_text_text_keyword_extraction_post
#
...
# @param string $model  (optional, default to 'keybert-paraphrase-MiniLM-L6-v2')
{
    ...
    __PACKAGE__->method_documentation->{ 'apply_text_text_keyword_extraction_post' } = { 
...
# @return object
#
sub apply_text_text_keyword_extraction_post {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/text/text/keyword-extraction/';
...
#
# get_versions_text_text_keyword_extraction_get
#
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'get_versions_text_text_keyword_extraction_get' } = { 
...
# @return object
#
sub get_versions_text_text_keyword_extraction_get {
    my ($self, %args) = @_;
