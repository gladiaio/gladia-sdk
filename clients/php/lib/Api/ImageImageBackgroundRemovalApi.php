...
/**
 * ImageImageBackgroundRemovalApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ImageImageBackgroundRemovalApi
{
    ...
    /**
     * Operation applyImageImageBackgroundRemovalPostWithHttpInfo
     *
     * Apply model for the background-removal task for a given models
     *
    ...
    /**
     * Operation applyImageImageBackgroundRemovalPostAsync
     *
     * Apply model for the background-removal task for a given models
     *
     * @param  \SplFileObject $image (required)
    ...
    /**
     * Operation applyImageImageBackgroundRemovalPostAsyncWithHttpInfo
     *
     * Apply model for the background-removal task for a given models
     *
     * @param  \SplFileObject $image (required)
    ...
    protected function applyImageImageBackgroundRemovalPostRequest($image, $model = 'xception')
    {
        ...
        if ($image === null || (is_array($image) && count($image) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $image when calling applyImageImageBackgroundRemovalPost'
            );
        }

        $resourcePath = '/image/image/background-removal/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return object
     */
    public function getVersionsImageImageBackgroundRemovalGet()
    {
        list($response) = $this->getVersionsImageImageBackgroundRemovalGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation getVersionsImageImageBackgroundRemovalGetWithHttpInfo
     *
     * Get list of models available for background-removal
     *
     *
     ...
     */
    public function getVersionsImageImageBackgroundRemovalGetWithHttpInfo()
    {
        $request = $this->getVersionsImageImageBackgroundRemovalGetRequest();
    ...
    /**
     * Operation getVersionsImageImageBackgroundRemovalGetAsync
     *
     * Get list of models available for background-removal
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVersionsImageImageBackgroundRemovalGetAsync()
    {
        return $this->getVersionsImageImageBackgroundRemovalGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVersionsImageImageBackgroundRemovalGetAsyncWithHttpInfo
     *
     * Get list of models available for background-removal
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVersionsImageImageBackgroundRemovalGetAsyncWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->getVersionsImageImageBackgroundRemovalGetRequest();
    ...
    /**
     * Create request for operation 'getVersionsImageImageBackgroundRemovalGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVersionsImageImageBackgroundRemovalGetRequest()
    {
