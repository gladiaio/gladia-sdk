...
*OpenapiClient::ImageTextAsciifyApi* | [**apply_image_text_asciify_post**](docs/ImageTextAsciifyApi.md#apply_image_text_asciify_post) | **POST** /image/text/asciify/ | Apply model for the asciify task for a given models
*OpenapiClient::ImageTextAsciifyApi* | [**get_versions_image_text_asciify_get**](docs/ImageTextAsciifyApi.md#get_versions_image_text_asciify_get) | **GET** /image/text/asciify/ | Get list of models available for asciify
*OpenapiClient::ImageTextOcrApi* | [**apply_image_text_ocr_post**](docs/ImageTextOcrApi.md#apply_image_text_ocr_post) | **POST** /image/text/ocr/ | Apply model for the ocr task for a given models
*OpenapiClient::ImageTextOcrApi* | [**get_versions_image_text_ocr_get**](docs/ImageTextOcrApi.md#get_versions_image_text_ocr_get) | **GET** /image/text/ocr/ | Get list of models available for ocr
...
*OpenapiClient::VideoVideoFrameInterpolationApi* | [**apply_video_video_frame_interpolation_post**](docs/VideoVideoFrameInterpolationApi.md#apply_video_video_frame_interpolation_post) | **POST** /video/video/frame-interpolation/ | Apply model for the frame-interpolation task for a given models
*OpenapiClient::VideoVideoFrameInterpolationApi* | [**get_versions_video_video_frame_interpolation_get**](docs/VideoVideoFrameInterpolationApi.md#get_versions_video_video_frame_interpolation_get) | **GET** /video/video/frame-interpolation/ | Get list of models available for frame-interpolation
...
## Documentation for Models
 ...
 - [OpenapiClient::BodyApplyImageTextAsciifyPost](docs/BodyApplyImageTextAsciifyPost.md)
 - [OpenapiClient::BodyApplyImageTextOcrPost](docs/BodyApplyImageTextOcrPost.md)
 - [OpenapiClient::BodyApplyVideoVideoFrameInterpolationPost](docs/BodyApplyVideoVideoFrameInterpolationPost.md)
