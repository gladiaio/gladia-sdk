...
module OpenapiClient
  class ImageImageBackgroundRemovalApi
    ...
    def apply_image_image_background_removal_post_with_http_info(image, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ImageImageBackgroundRemovalApi.apply_image_image_background_removal_post ...'
      end
      ...
      # resource path
      local_var_path = '/image/image/background-removal/'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ImageImageBackgroundRemovalApi#apply_image_image_background_removal_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def get_versions_image_image_background_removal_get(opts = {})
      data, _status_code, _headers = get_versions_image_image_background_removal_get_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def get_versions_image_image_background_removal_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ImageImageBackgroundRemovalApi.get_versions_image_image_background_removal_get ...'
      end
      # resource path
      local_var_path = '/image/image/background-removal/'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ImageImageBackgroundRemovalApi#get_versions_image_image_background_removal_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
