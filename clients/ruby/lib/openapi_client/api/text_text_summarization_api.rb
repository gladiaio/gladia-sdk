...
module OpenapiClient
  class TextTextSummarizationApi
    ...
    # @option opts [Integer] :max_length  (default to 512)
    # @option opts [Integer] :min_length  (default to 40)
    # @option opts [String] :model  (default to 'distilbart-cnn-12-6')
    # @return [Object]
    def apply_text_text_summarization_post(opts = {})
      data, _status_code, _headers = apply_text_text_summarization_post_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :max_length 
    # @option opts [Integer] :min_length 
    # @option opts [String] :model 
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def apply_text_text_summarization_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TextTextSummarizationApi.apply_text_text_summarization_post ...'
      end
      # resource path
      local_var_path = '/text/text/summarization/'
      ...
      query_params[:'max_length'] = opts[:'max_length'] if !opts[:'max_length'].nil?
      query_params[:'min_length'] = opts[:'min_length'] if !opts[:'min_length'].nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TextTextSummarizationApi#apply_text_text_summarization_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def get_versions_text_text_summarization_get(opts = {})
      data, _status_code, _headers = get_versions_text_text_summarization_get_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def get_versions_text_text_summarization_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TextTextSummarizationApi.get_versions_text_text_summarization_get ...'
      end
      # resource path
      local_var_path = '/text/text/summarization/'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TextTextSummarizationApi#get_versions_text_text_summarization_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
