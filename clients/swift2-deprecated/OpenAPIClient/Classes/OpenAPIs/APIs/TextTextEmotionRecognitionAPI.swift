...
public class TextTextEmotionRecognitionAPI: APIBase {
     ...
     */
    public class func applyTextTextEmotionRecognitionPost(text text: String? = nil, model: Model_applyTextTextEmotionRecognitionPost? = nil, completion: ((data: AnyObject?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func applyTextTextEmotionRecognitionPostWithRequestBuilder(text text: String? = nil, model: Model_applyTextTextEmotionRecognitionPost? = nil) -> RequestBuilder<AnyObject> {
