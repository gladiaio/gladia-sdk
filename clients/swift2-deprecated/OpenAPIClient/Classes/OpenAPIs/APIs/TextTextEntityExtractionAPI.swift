...
public class TextTextEntityExtractionAPI: APIBase {
     ...
     */
    public class func applyTextTextEntityExtractionPost(inputString inputString: String? = nil, model: Model_applyTextTextEntityExtractionPost? = nil, completion: ((data: AnyObject?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func applyTextTextEntityExtractionPostWithRequestBuilder(inputString inputString: String? = nil, model: Model_applyTextTextEntityExtractionPost? = nil) -> RequestBuilder<AnyObject> {
