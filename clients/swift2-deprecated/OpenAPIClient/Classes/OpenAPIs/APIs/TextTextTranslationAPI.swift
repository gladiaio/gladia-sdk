...
public class TextTextTranslationAPI: APIBase {
     ...
     */
    public class func applyTextTextTranslationPost(inputString inputString: String? = nil, sourceLanguage: String? = nil, targetLanguage: String? = nil, model: String? = nil, completion: ((data: AnyObject?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func applyTextTextTranslationPostWithRequestBuilder(inputString inputString: String? = nil, sourceLanguage: String? = nil, targetLanguage: String? = nil, model: String? = nil) -> RequestBuilder<AnyObject> {
