...
open class TextTextEmotionRecognitionAPI: APIBase {
     ...
     */
    open class func applyTextTextEmotionRecognitionPost(text: String? = nil, model: Model_applyTextTextEmotionRecognitionPost? = nil, completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
