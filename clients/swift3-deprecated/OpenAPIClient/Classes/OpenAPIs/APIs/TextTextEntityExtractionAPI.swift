...
open class TextTextEntityExtractionAPI: APIBase {
     ...
     */
    open class func applyTextTextEntityExtractionPost(inputString: String? = nil, model: Model_applyTextTextEntityExtractionPost? = nil, completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
