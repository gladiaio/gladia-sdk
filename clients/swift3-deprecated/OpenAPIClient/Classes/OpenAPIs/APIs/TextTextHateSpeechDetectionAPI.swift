...
open class TextTextHateSpeechDetectionAPI: APIBase {
     ...
     */
    open class func applyTextTextHateSpeechDetectionPost(text: String? = nil, model: Model_applyTextTextHateSpeechDetectionPost? = nil, completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
     ...
     */
    open class func applyTextTextHateSpeechDetectionPostWithRequestBuilder(text: String? = nil, model: Model_applyTextTextHateSpeechDetectionPost? = nil) -> RequestBuilder<Any> {
