...
open class TextTextTranslationAPI: APIBase {
     ...
     */
    open class func applyTextTextTranslationPost(inputString: String? = nil, sourceLanguage: String? = nil, targetLanguage: String? = nil, model: String? = nil, completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
