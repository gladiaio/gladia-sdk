...
class Decoders {
    ...
    private static var __once: () = {
        ...
        // Decoder for [BodyApplyImageTextAsciifyPost]
        Decoders.addDecoder(clazz: [BodyApplyImageTextAsciifyPost].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[BodyApplyImageTextAsciifyPost]> in
            return Decoders.decode(clazz: [BodyApplyImageTextAsciifyPost].self, source: source)
        }

        // Decoder for BodyApplyImageTextAsciifyPost
        Decoders.addDecoder(clazz: BodyApplyImageTextAsciifyPost.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<BodyApplyImageTextAsciifyPost> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? BodyApplyImageTextAsciifyPost() : instance as! BodyApplyImageTextAsciifyPost
                switch Decoders.decodeOptional(clazz: URL.self, source: sourceDictionary["image"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "BodyApplyImageTextAsciifyPost", actual: "\(source)"))
            }
        }
        // Decoder for [BodyApplyImageTextOcrPost]
        Decoders.addDecoder(clazz: [BodyApplyImageTextOcrPost].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[BodyApplyImageTextOcrPost]> in
            return Decoders.decode(clazz: [BodyApplyImageTextOcrPost].self, source: source)
        }

        // Decoder for BodyApplyImageTextOcrPost
        Decoders.addDecoder(clazz: BodyApplyImageTextOcrPost.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<BodyApplyImageTextOcrPost> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? BodyApplyImageTextOcrPost() : instance as! BodyApplyImageTextOcrPost
                switch Decoders.decodeOptional(clazz: URL.self, source: sourceDictionary["image"] as AnyObject?) {
