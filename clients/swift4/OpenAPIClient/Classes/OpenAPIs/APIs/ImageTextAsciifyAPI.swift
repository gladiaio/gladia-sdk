...
open class ImageTextAsciifyAPI {
    /**
    ...
    /**
     ...
     - parameter model: (query)  (optional, default to .ramesh-aditya)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func applyImageTextAsciifyPost(image: URL, model: Model_applyImageTextAsciifyPost? = nil, completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsImageTextAsciifyGet(completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
