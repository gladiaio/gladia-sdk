...
open class TextTextSummarizationAPI {
     ...
     */
    open class func applyTextTextSummarizationPost(text: String? = nil, sourceLanguage: String? = nil, maxLength: Int? = nil, minLength: Int? = nil, model: String? = nil, completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
     ...
     */
    open class func applyTextTextSummarizationPostWithRequestBuilder(text: String? = nil, sourceLanguage: String? = nil, maxLength: Int? = nil, minLength: Int? = nil, model: String? = nil) -> RequestBuilder<Any> {
