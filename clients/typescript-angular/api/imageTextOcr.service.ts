...
export class ImageTextOcrService {
    ...
    public applyImageTextOcrPost(image: Blob, sourceLanguage?: string, model?: 'tesseract-denoising' | 'easy-ocr' | 'tesseract-default', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<object>(`${this.configuration.basePath}/image/text/ocr/`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getVersionsImageTextOcrGet(observe?: 'body', reportProgress?: boolean): Observable<object>;
    public getVersionsImageTextOcrGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public getVersionsImageTextOcrGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public getVersionsImageTextOcrGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<object>(`${this.configuration.basePath}/image/text/ocr/`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
