...
export class TextTextEmotionRecognitionService {
     ...
     */
    public applyTextTextEmotionRecognitionPost(text?: string, model?: 'mrm8488-t5-base-finetuned-emotion', observe?: 'body', reportProgress?: boolean): Observable<object>;
    public applyTextTextEmotionRecognitionPost(text?: string, model?: 'mrm8488-t5-base-finetuned-emotion', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public applyTextTextEmotionRecognitionPost(text?: string, model?: 'mrm8488-t5-base-finetuned-emotion', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public applyTextTextEmotionRecognitionPost(text?: string, model?: 'mrm8488-t5-base-finetuned-emotion', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
