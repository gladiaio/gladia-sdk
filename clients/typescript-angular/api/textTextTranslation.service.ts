...
export class TextTextTranslationService {
     ...
     */
    public applyTextTextTranslationPost(inputString?: string, sourceLanguage?: string, targetLanguage?: string, model?: string, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public applyTextTextTranslationPost(inputString?: string, sourceLanguage?: string, targetLanguage?: string, model?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public applyTextTextTranslationPost(inputString?: string, sourceLanguage?: string, targetLanguage?: string, model?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public applyTextTextTranslationPost(inputString?: string, sourceLanguage?: string, targetLanguage?: string, model?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
