...
export enum ImageTextOcrApiApiKeys {
}

export class ImageTextOcrApi {
    ...
    public setApiKey(key: ImageTextOcrApiApiKeys, value: string) {
        (this.authentications as any)[ImageTextOcrApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getVersionsImageTextOcrGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/image/text/ocr/';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
