...
export interface ApplyTextTextEmotionRecognitionPostRequest {
    text?: string;
    model?: ApplyTextTextEmotionRecognitionPostModelEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum ApplyTextTextEmotionRecognitionPostModelEnum {
    Mrm8488T5BaseFinetunedEmotion = 'mrm8488-t5-base-finetuned-emotion'
}
