...
export interface ApplyTextTextHateSpeechDetectionPostRequest {
    text?: string;
    model?: ApplyTextTextHateSpeechDetectionPostModelEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum ApplyTextTextHateSpeechDetectionPostModelEnum {
    HateSpeechCNERGDehatebertMonoEnglish = 'Hate-speech-CNERG-dehatebert-mono-english'
}
